...
sed -i "sudo sed '13a\ \{ \"disp\": \"$nombre_sala\", \"tg\": \"$sala\" \},' /opt/Analog_Reflector/arRoot/modes/YSF_node_list.json > /opt/Analog_Reflector/arRoot/modes/YSF_node_list1.json
